...
# You must use python to analyze the GenBank entry to receive credit, and
# your code must be generic to work with any entry.
# Notes: for (5), use python splicing to extract the nucleotides from the 
# seq_record sequence object. This will give you a Bio.Seq object. Then 
# use the translate method of the Bio.Seq object to translate the sequence.
...
# multiple genes), and that the last exon contains at least 3 codons.
##########################################################################
